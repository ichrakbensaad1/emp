...
const Edit = () => {
  ...
  const submitUserData = (e) => {
    e.preventDefault();
    const { fname,
      lname, email, contact, gender, location, emploi, departement } = inputdata;
    if (fname === ""){
      ...
      Toast.error("Entre Valif Mobile!")
    }else if (gender ==""){
          ...
          <form className='mt-3 p-3'>
            ...
            <div className='row'>
              ...
              <div class="mb-4 col-lg-6 col-md-4 col-6">
                ...
                <input type="text" name=" emploi" class="form-control" id="exampleInputEmail1" />
              </div>
